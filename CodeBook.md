...
The data was then unzipped and the following text-files were saved as tab delimited txt-files:
- X_test.txt
- y_test.txt
- subject_test.txt
- X_train.txt
...
The files contain the folllowing data:
- X_test.txt: information to 561 variables and 2947 measurements
- y_test.txt: information to activity-status of 2947 measurements
- subject_test.txt subject nr to 2947 measurements

These three data sets are put together to the test data set in the following.

- X_train.txt: information to 561 variables and 7352 measurements
- y_train.txt: information to activity-status of 7352 measurements
- subject_train.txt subject nr to 7352 measurements

These three data sets are put together to the train data set in the following.

- features.txt: information to 561 variable names
- activity_labels.txt: information which allows the conversion of activity labels to activity names

The test and the train data set are put together and the variables are renamed according to 
